...
Welcome! This is a Python-based program that I wrote on PyCharm.
Please run it in PyCharm, because I’m not sure whether it will work properly in other IDEs.

This is a program that automatically retrieves the data of videos and uploaders (also users)  from Bilibili.It is one of the largest long video platforms in China like YouTube.
...
1. This program is very easy to use. It only needs a computer that can run PyCharm.
...
4. Don’t worry about whether this program can analyze your URL, because the code can handle any URL that contains BVID (The BiliBili video identifier) or UID (User ID). If you enter a correct link, the link will always include one of them.


5. If it runs successfully, you will see the information appear on the panel.
